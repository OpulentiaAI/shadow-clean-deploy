      ...
      <DialogContent showCloseButton={false}>
        ...
        <div className="flex flex-col gap-4">
          <p className="text-muted-foreground text-sm">
            Welcome to Opulent OS! Complete the following steps to get started. This
          ...
          <div className="mt-3 flex items-start gap-3">
            ...
            <div className="flex flex-col items-start gap-0.5">
              <div className="flex items-center gap-2">
                <p className="font-medium">Connect the Opulent OS GitHub App</p>
                {githubStatus?.isAppInstalled && (
                  <Check className="size-4 text-green-400" />
                )}
              </div>
              <p className="text-muted-foreground pb-2 text-sm">
                Gives Opulent OS access to work on your existing repositories.
              </p>
              <Button
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex flex-col items-start gap-0.5">
              ...
              <p className="text-muted-foreground pb-2 text-sm">
                Opulent OS is BYOK; enter your own API keys to use the models.
              </p>
            ...
            <div className="bg-card rounded-lg border p-3">
              <div className="flex flex-col gap-3">
                <p className="text-muted-foreground text-[13px] leading-tight">
                  ...
                  enterprise-grade security with Opulent OS. Your API keys are never
