...
export function SidebarNavigation({
  ...
  const statusColor = useMemo(() => {
    if (task) {
      return statusColorsConfig[task.status as keyof typeof statusColorsConfig].bg;
    }

    return currentTaskStatus ? statusColorsConfig[currentTaskStatus as keyof typeof statusColorsConfig].bg : "";
