              ...
              <a href={`/tasks/${task.id}`} className="w-full overflow-hidden">
                ...
                <div className="text-muted-foreground flex max-w-full items-center gap-1 overflow-hidden text-xs">
                  {groupBy === "repo" ? (
                    <>
                      <StatusIcon
                        className={`!size-3 shrink-0 ${statusColorsConfig[displayStatus as keyof typeof statusColorsConfig].className}`}
                      />
                ...
                >
                  <SidebarGroup>
                    <SidebarGroupLabel asChild>
                      <CollapsibleTrigger>
                        <StatusIcon
                          className={`mr-1.5 !size-3.5 ${statusColorsConfig[displayStatus as keyof typeof statusColorsConfig].className} ${displayStatus === "INITIALIZING" ? "animation-duration-[5s] size-4 animate-spin" : ""}`}
                        />
