...
import { PullRequestSnapshot } from "@repo/types";
import { useTask } from "@/hooks/tasks/use-task";
import Image from "next/image";
import { MemoizedMarkdown } from "../markdown/memoized-markdown";

// Remove the last --- and everything after it (because we manually add a link to the Opulent OS workspace at the end of descriptions)
